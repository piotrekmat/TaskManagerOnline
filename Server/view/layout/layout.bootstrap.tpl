...
<html lang="en">
    ...
    "`$basePath`/images/favicon.ico"])}
        ...
        {$this->headScript()->appendFile("`$basePath`/js/bootstrap.min.js", "text/javascript", "text/javascript")}
        {*$this->headScript()->appendFile("http://code.jquery.com/jquery-1.11.0.min.js.js", "text/javascript")*}
        ...
        <div class="container body">
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    ...
                    <footer>
                        <div class="">
                            <p class="pull-right">Zend Framework with a Bootstrap 3 template by <a>Kimlabs</a>. |
                                <span class="lead"> <i class="fa fa-paw"></i> Zend Framework 2</span>
                            </p>
                        </div>
                        <div class="clearfix"></div>
                    </footer>
